...
public class CustomCheckBox extends LinearLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private OnCheckChangedListener m_OnCheckChangedListener = null;
    ...
    public interface OnCheckChangedListener {
         ...
         * @param check
         */
        void OnCheckChanged(CustomCheckBox object, boolean check);
    }
     ...
     * @param listener
     */
    public void setCheckChangedListener(OnCheckChangedListener listener) {
        m_OnCheckChangedListener = listener;
    }
    ...
    public void onClick(View v) {
        ...
        if(m_OnCheckChangedListener != null) {
            m_OnCheckChangedListener.OnCheckChanged(this, m_Checked);
        }
    }
